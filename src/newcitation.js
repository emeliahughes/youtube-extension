            ...
            <form onSubmit={handleSubmit}>
                <div className="form-around">
                    ...
                    <div className='row'>
                        ...
                        <label htmlFor="link_field" className="main-labels col-1"><h3>Link:</h3></label>
                        <input type="text" 
                            onChange={handleLink} 
                            value={inputLinkValue} 
                            className="form-control col-6 h4" id="link_field" name="link" required/>

                        <label htmlFor="start_time_field" className="main-labels col"><h3>From: </h3></label>
                        <input type="text" 
                            onChange={handleStartTime} 
                            value={inputStartTimeValue} 
                            className="form-control col h4" id="start_time_field" name="start_time" required/>

                        <label htmlFor="end_time_field" className="main-labels col"><h3> To: </h3></label>
                        <input type="text" 
                            onChange={handleEndTime} 
                            value={inputEndTimeValue} 
                            className="form-control col h4" id="end_time_field" name="end_time" required/>
