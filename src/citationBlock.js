        ...
        <div className="citation-block card rounded-lg m-2">
            ...
            <div className='card-body row ml-1 text-body'>
                <div className='col p-2 mr-auto ml-4'>
                    ...
                    <a href={link} onClick={handleTrackUserClick.bind(this, "articleLink")} className="citation-source card-link pb-1" target="_blank"><h4>Visit {sourceType}</h4></a>
                </div>
                <div className='col-auto m-2 mr-auto'>
                    <div className='row justify-content-end m-3'>
                        <button onClick={"jumpTime.bind(this, startTime); handleTrackUserClick.bind(this, 'startTime')"} className='btn btn-secondary rounded-lg card-link align-items-center p-2 mx-2 mr-0 ml-2'>
